...
//TURN server nếu sau muốn phát triển call 2 máy (đang mắc đây)
// const iceServers = {
//   iceServers: [
...
//phát triển cục bộ nên dùng STUN server của Google
const iceServers = {
...
// let socket = io.connect(`https://${LOCAL_IP_ADDRESS}`, {secure: true}); // có liên quan https
